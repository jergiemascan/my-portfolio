    ...
    <Section>
      <div className="section">
        <Content>
          ...
          <h2>
            I'm Jergie Mascan, a goal-driven Front-end Developer from in
            Stockholm, Sweden. My journey into web development opened up a
            passion for creating innovative solutions and optimal user
            experiences through my frontend skills. Most of my projects are
            built with JavaScript, TypeScript, React and Node.js, but I also
            have basic knowledge of ASP.NET and Umbraco.
          </h2>
          <h2>
